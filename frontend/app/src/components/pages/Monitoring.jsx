...
const Monitoring = () => {
    ...
    const fetchTrees = async () => {
        try {
            const response = await axios.get('https://arborizacao-urbana-5t3godv48-viniglienkes-projects.vercel.app/trees');
    ...
    const handleDeleteClick = async (id) => {
        try {
            await axios.delete(`https://arborizacao-urbana-5t3godv48-viniglienkes-projects.vercel.app/trees/${id}`);
            fetchTrees();
        } catch (error) {
    ...
    const handleUpdateSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`https://arborizacao-urbana-5t3godv48-viniglienkes-projects.vercel.app/trees/${currentTree.id}`, {
